        ...
        <div class="section-body">
            <div class="p-4 card">
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url('admin/product_controller/addProduct'); ?>" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            <label for="">Product Name</label>
                            <input type="text" name="product_name" class="form-control rounded-pill" id="" value="<?= set_value('product_name') ?>" placeholder="Enter product name">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <select class="form-control rounded-pill" name="category_id" value="<?= set_value('category_id') ?>" id="category">
                            ...
                            <div class="col form-group">
                                ...
                                <input type="number" class="form-control rounded-pill" name="price" value="<?= set_value('price') ?>" id="exampleInputPassword" placeholder="Enter price">
                            ...
                            <div class="col-sm-9">
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <textarea name="description" class="form-control rounded" value="<?= set_value('description') ?>" id="" cols="55" rows="4"></textarea>
                                ...
                                <div class="row">
                                    <div class="col form-group">
                                        ...
                                        <input type="file" class="form-control rounded-pill" name="image_product" accept="image/*" id="preview_gambar">
