            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <?php else : ?>
                            <li class="nav-item active"><a class="nav-link" href="<?= base_url('user/pelanggan_controller'); ?>">Home</a></li>
                        <?php endif; ?>
                        <!-- TESTIMONI -->
                        ...
                        <?php else : ?>
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a data-toggle="modal" data-target="#logoutModal"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        <!-- <li class="nav-item"><a class="nav-link" href="<?= base_url(); ?>auth_controller">Login <i class="fa fa-user"></i></a></li> -->
