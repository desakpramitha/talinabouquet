                    ...
                    <div class="product-categori">
                        ...
                        <div class="filter-sidebar-left">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                                <a href="<?= base_url() ?>dashboard_controller/shop" class="list-group-item list-group-item-action">All</a>
                        ...
                        <div class="row product-categorie-box">
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row">
                                        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-12 mb-3">
                                            <h4>Result Category : <strong><?= $categoryName['category_name'] ?></strong></h4>
                                        </div>
                                        <?php if (!$product) { ?>
                                            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-12">
                                                <h4 class="alert alert-danger text-center"><strong>No Result</strong></h4>
                                            </div>
