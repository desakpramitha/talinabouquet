                ...
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <div class="checkout-address">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="pelanggan_name" id="pelanggan_name" placeholder="Nama Penerima" value="<?= set_value('pelanggan_name') ?>">
                                <?= form_error('pelanggan_name', '<div class="text-danger">', '</div>') ?>
                            </div>

                            <div class="mb-3">
                                <label for="fullName">Phone *</label>
                                <input type="text" class="form-control" name="pelanggan_phone" id="pelanggan_phone" placeholder="Phone Number" value="<?= set_value('pelanggan_phone') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="date_pengiriman" id="datepicker">

                                <?= form_error('date_pengiriman', '<div class="text-danger">', '</div>') ?>

                            </div>
                            <div class="mb-3">
                                <label for="note">Pesan Ucapan</label><br>
                                <textarea class="wide w-100" name="note" id="note" placeholder="Enter Note (optional)"></textarea>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="order-box mt-5">
                            ...
                            <input type="hidden" class="form-control" name="email" id="email" placeholder="" value="<?= $this->session->userdata('email') ?>">
